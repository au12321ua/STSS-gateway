...
envsubst '${AUTH_SERVICE_URL} ${INFO_SERVICE_URL} ${COURSE_SELECTION_SERVICE_URL} ${GATEWAY_PORT} ${CORS_ORIGINS} ${RATE_LIMIT_LOGIN} ${GATEWAY_CLIENT_ID} ${GATEWAY_CLIENT_SECRET} ${SERVICE_TOKEN}' \
