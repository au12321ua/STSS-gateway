...
export COURSE_SELECTION_SERVICE_URL="${COURSE_SELECTION_SERVICE_URL:-course-selection-api:8003}"
export FORUM_SERVICE_URL="${FORUM_SERVICE_URL:-forum_service:8004}"
export ONLINE_TEST_SERVICE_URL="${ONLINE_TEST_SERVICE_URL:-online_test_service:8005}"
export GRADE_SERVICE_URL="${GRADE_SERVICE_URL:-grade_service:8006}"
